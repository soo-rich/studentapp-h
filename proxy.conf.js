...
//
// Préfixes repris du contrat `studentapi/docs/openapi.yaml` (v0.4.0) — tags `auth`, `students`,
// `moderation`, `verification`, `recruiters`, `offers`. Doivent rester synchronisés avec
// `API_PATH_PREFIXES` dans `src/app/core/auth/auth.interceptor.ts`.
//
